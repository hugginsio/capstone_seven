  ...
  export class GameBoard {
    ...
    constructor() {
      ...
      */
      ...
      this.branches[17].setBranch(2, 11);
      this.branches[17].setBranch(3, 22);
      
      this.branches[18].setBranch(1, 7);
      this.branches[18].setBranch(2, 12);
      this.branches[18].setBranch(3, 23);
      this.branches[18].setBranch(4, 27);
      this.branches[18].setBranch(5, 22);
      this.branches[18].setBranch(6, 11);

      this.branches[19].setBranch(1, 8);
      this.branches[19].setBranch(2, 13);
      this.branches[19].setBranch(3, 24);
      this.branches[19].setBranch(4, 28);
      this.branches[19].setBranch(5, 23);
      this.branches[19].setBranch(6, 12);
      
      this.branches[20].setBranch(1, 9);
      this.branches[20].setBranch(2, 14);
      this.branches[20].setBranch(3, 25);
      this.branches[20].setBranch(4, 29);
      this.branches[20].setBranch(5, 24);
      this.branches[20].setBranch(6, 13);
      
      this.branches[21].setBranch(1, 10);
      this.branches[21].setBranch(2, 15);
      this.branches[21].setBranch(3, 26);
      this.branches[21].setBranch(4, 30);
      this.branches[21].setBranch(5, 25);
      this.branches[21].setBranch(6, 14);

      this.branches[22].setBranch(5, 26);
      this.branches[22].setBranch(6, 15);
      
      this.branches[23].setBranch(1, 17);
      this.branches[23].setBranch(2, 23);
      this.branches[23].setBranch(3, 27);
      this.branches[23].setBranch(6, 16);
      
      this.branches[24].setBranch(1, 18);
      this.branches[24].setBranch(2, 24);
      this.branches[24].setBranch(3, 28);
      this.branches[24].setBranch(4, 27);
      this.branches[24].setBranch(5, 22);
      this.branches[24].setBranch(6, 17);
      
      this.branches[25].setBranch(1, 19);
      this.branches[25].setBranch(2, 25);
      this.branches[25].setBranch(3, 29);
      this.branches[25].setBranch(4, 28);
      this.branches[25].setBranch(5, 23);
      this.branches[25].setBranch(6, 18);
      
      this.branches[26].setBranch(1, 20);
      this.branches[26].setBranch(2, 26);
      this.branches[26].setBranch(3, 30);
      this.branches[26].setBranch(4, 29);
      this.branches[26].setBranch(5, 24);
      this.branches[26].setBranch(6, 19);
      
      this.branches[27].setBranch(1, 21);
      this.branches[27].setBranch(4, 30);
      this.branches[27].setBranch(5, 25);
      this.branches[27].setBranch(6, 20);
      
      this.branches[28].setBranch(1, 17);
      this.branches[28].setBranch(2, 23);
      this.branches[28].setBranch(3, 31);
      this.branches[28].setBranch(6, 22);

      this.branches[29].setBranch(1, 18);
      this.branches[29].setBranch(2, 24);
      this.branches[29].setBranch(3, 32);
      this.branches[29].setBranch(4, 34);
      this.branches[29].setBranch(5, 31);
      this.branches[29].setBranch(6, 23);
      
      this.branches[30].setBranch(1, 19);
      this.branches[30].setBranch(2, 25);
      this.branches[30].setBranch(3, 33);
      this.branches[30].setBranch(4, 35);
      this.branches[30].setBranch(5, 32);
      this.branches[30].setBranch(6, 24);
      
      this.branches[31].setBranch(1, 20);
      this.branches[31].setBranch(2, 26);
      this.branches[31].setBranch(5, 33);
      this.branches[31].setBranch(6, 25);

      this.branches[32].setBranch(1, 28);
      this.branches[32].setBranch(2, 32);
      this.branches[32].setBranch(3, 34);
      this.branches[32].setBranch(6, 27);
      
      this.branches[33].setBranch(1, 29);
      this.branches[33].setBranch(2, 33);
      this.branches[33].setBranch(3, 35);
      this.branches[33].setBranch(4, 34);
      this.branches[33].setBranch(5, 31);
      this.branches[33].setBranch(6, 28);
      ...
      */
      ...
      this.tiles[4].setBottomBranch(23);
      ...
      */
      ...
      this.nodes[6].setBottomBranch(16);
      ...
      this.nodes[8].setBottomBranch(18);
      ...
      this.nodes[22].setTopRightTile(32);
