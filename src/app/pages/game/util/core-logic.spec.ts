...
//   xdescribe('check for 2 captures', ()=>{
...
//   xdescribe('check for longest network', ()=>{
...
//       expect(state.getBoard().nodes[8].getOwner()).toEqual(Owner.PLAYERONE);
//       expect(state.getBoard().branches[8].getOwner()).toEqual(Owner.PLAYERONE);
//       expect(state.getBoard().branches[18].getOwner()).toEqual(Owner.PLAYERONE);
...
//   xdescribe('Apply move with capture and longest network', ()=>{
//     it('should apply move string to current state',()=>{
//       const gameBoard = new GameBoard();
//       gameBoard.randomizeColorsAndMaxNodes();
//       gameBoard.branches[12].setOwner(Owner.PLAYERONE);
...
//   xdescribe('Next State Initial Moves', ()=>{
...
//   xdescribe('Next State conventional moves', ()=>{
...
//   xdescribe('Get legal moves for initial turn', ()=>{
...
//   xdescribe('Get legal moves for initial turn 2', ()=>{
...
//   xdescribe('Get legal moves for initial turns cloned', ()=>{
...
//   xdescribe('Get legal moves for regular turn', ()=>{
